...
<body>
    ...
    <main style="padding: 0; overflow-x: hidden;">
        ...
        <section>
            <div class="container text-center" style="font-family: 'Inter', sans-serif;">
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center g-4">
                    ...
                    <div class="col-12 col-md-6 order-2">
                        ...
                        style="color: #333333; text-align: center !important; font-family: 'Inter', sans-serif;">
                        Sobre o Instituto Zoe
                        </p>
                        <p class="section-text text-md-start text-center" style="color: black;font-family: 'Inter', sans-serif;">
                        ...
                        <p class="section-text mb-4 text-md-start text-center" style="color: black;font-family: 'Inter', sans-serif;">
