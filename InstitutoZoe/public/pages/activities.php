...
<body>
    ...
    <main style="padding: 0; overflow-x: hidden;">
        ...
        <section class="banner-container">
            <img src="../assets/images/Atividades.svg" class="banner-img" alt="Banner do Instituto Zoe" data-aos="fade-right"
                data-aos-delay="450">
        </section>
        ...
        <div class="container my-5">
            <div class="servicos row gy-5" style="justify-content: space-around;">
                ...
                <div class="col-lg-5 col-md-6" data-aos="fade-down-right" data-aos-delay="0">
                    <a href="index-agend.html">
                        <div class="card shadow rounded-4 overflow-hidden h-100">
                            <img src="../assets/images/fisioterapia.jpg" class="w-100 card-img-uniform" alt="Fisioterapia">
                ...
                <div class="col-lg-5 col-md-6" data-aos="fade-down-left" data-aos-delay="150">
                    <a href="index-agend.html">
                        <div class="card shadow rounded-4 overflow-hidden h-100">
                            <img src="../assets/images/funcional.jpg" class="w-100 card-img-uniform" alt="Funcional">
                            <div class="card-body bg-light p-3">
                ...
                <div class="col-lg-5 col-md-6" data-aos="fade-right" data-aos-delay="0">
                    <a href="index-agend.html">
                        <div class="card shadow rounded-4 overflow-hidden h-100">
                            <img src="../assets/images/hidro.jpg" class="w-100 card-img-uniform" alt="Hidroginástica">
                            <div class="card-body bg-light p-3">
                ...
                <div class="col-lg-5 col-md-6" data-aos="fade-left" data-aos-delay="150">
                    <a href="index-agend.html">
                        <div class="card shadow rounded-4 overflow-hidden h-100">
                            <img src="../assets/images/ballet.png" class="w-100 card-img-uniform" alt="Ballet">
                            <div class="card-body bg-light p-3">
                ...
                <div class="col-lg-5 col-md-6" data-aos="fade-right" data-aos-delay="0">
                    <a href="index-agend.html">
                        <div class="card shadow rounded-4 overflow-hidden h-100">
                            <img src="../assets/images/jiu-jitsu.png" class="w-100 card-img-uniform" alt="Jiu-Jitsu">
                            <div class="card-body bg-light p-3">
                ...
                <div class="col-lg-5 col-md-6" data-aos="fade-left" data-aos-delay="150">
                    <a href="index-agend.html">
                        <div class="card shadow rounded-4 overflow-hidden h-100">
                            <img src="../assets/images/natação.png" class="w-100 card-img-uniform" alt="Natação">
                            <div class="card-body bg-light p-3">
