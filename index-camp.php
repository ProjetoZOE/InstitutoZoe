                        ...
                        <div id="carousel-ballet" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            <div class="carousel-inner rounded-top-4">
                                <div class="carousel-item active ">
                                    <img src="img/Ballet/ballet1.jpeg" class="d-block w-100" style="height: 70vh;"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/Ballet/Ballet.jpg" class="d-block w-100" style="height: 70vh;"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/Ballet/ballet2.jpeg" class="d-block w-100" style="height: 70vh;"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/Ballet/ballet3.jpeg" class="d-block w-100" style="height: 70vh;"
                                        alt="...">
                                </div>
                            </div>
                ...
                <div class="col">
                    <div class="card h-100 shadow border-0 rounded-4" data-aos="fade-left" data-aos-delay="150">
                        ...
                        <div id="carousel-mutirao" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner rounded-top-4">
                                <div class="carousel-item active ">
                                    <img src="img/Multirão/multirao.jpeg" class="d-block w-100" style="height: 70vh;"
                                        alt="...">
                                </div>
                ...
                <div class="col">
                    <div class="card h-100 shadow border-0 rounded-4" data-aos="fade-right" data-aos-delay="0">
                        ...
                        <div id="carousel-autismo" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner rounded-top-4">
                                <div class="carousel-item active">
                                    <img src="img/Palestra/palestra.jpeg" class="d-block w-100" style="height: 70vh;"
                                        alt="...">
                                </div>
                ...
                <div class="col">
                    <div class="card h-100 shadow border-0 rounded-4" data-aos="fade-left" data-aos-delay="150">
                        ...
                        <div id="carousel-datas" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            <div class="carousel-inner rounded-top-4">
                                <div class="carousel-item active">
                                    <img src="img/Comemorativas/comemorativa.jpeg" class="d-block w-100"
                                        style="height: 70vh;" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/Comemorativas/comemorativa1.jpeg" class="d-block w-100"
                                        style="height: 70vh;" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/Comemorativas/comemorativa2.jpeg" class="d-block w-100"
                                        style="height: 70vh;" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/Comemorativas/comemorativa3.jpeg" class="d-block w-100"
                                        style="height: 70vh;" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/Comemorativas/comemorativa4.jpeg" class="d-block w-100"
                                        style="height: 70vh;" alt="...">
                                </div>
                            </div>
